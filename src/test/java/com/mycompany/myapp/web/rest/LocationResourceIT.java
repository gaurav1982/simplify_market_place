...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().country(DEFAULT_COUNTRY).state(DEFAULT_STATE).city(DEFAULT_CITY);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().country(UPDATED_COUNTRY).state(UPDATED_STATE).city(UPDATED_CITY);
        return location;
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.country(UPDATED_COUNTRY).state(UPDATED_STATE).city(UPDATED_CITY);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.country(UPDATED_COUNTRY).city(UPDATED_CITY);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.country(UPDATED_COUNTRY).state(UPDATED_STATE).city(UPDATED_CITY);
