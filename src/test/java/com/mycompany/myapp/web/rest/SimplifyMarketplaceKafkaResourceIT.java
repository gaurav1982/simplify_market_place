...
class SimplifyMarketplaceKafkaResourceIT {
    ...
    void setup() {
        ...
        SimplifyMarketplaceKafkaResource kafkaResource = new SimplifyMarketplaceKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/simplify-marketplace-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/simplify-marketplace-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
