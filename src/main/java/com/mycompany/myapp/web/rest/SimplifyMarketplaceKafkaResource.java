...
@RestController
@RequestMapping("/api/simplify-marketplace-kafka")
public class SimplifyMarketplaceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SimplifyMarketplaceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SimplifyMarketplaceKafkaResource(KafkaProperties kafkaProperties) {
