...
public class ClientResource {
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(
                existingClient -> {
                    if (client.getCompName() != null) {
                        existingClient.setCompName(client.getCompName());
                    }
                    if (client.getCompAddress() != null) {
                        existingClient.setCompAddress(client.getCompAddress());
                    }
                    if (client.getCompWebsite() != null) {
                        existingClient.setCompWebsite(client.getCompWebsite());
                    }
                    if (client.getCompType() != null) {
                        existingClient.setCompType(client.getCompType());
                    }
                    if (client.getCompContactNo() != null) {
                        existingClient.setCompContactNo(client.getCompContactNo());
                    }
                    ...
                    if (client.getUpdatedAt() != null) {
                        existingClient.setUpdatedAt(client.getUpdatedAt());
                    }
