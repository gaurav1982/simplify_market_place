...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKER actions', async () => {
      const expectedActions = [
        {
