...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIELD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIELD actions', async () => {
      const expectedActions = [
        {
