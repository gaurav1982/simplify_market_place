...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './job-specific-field.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBSPECIFICFIELD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_JOBSPECIFICFIELDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_JOBSPECIFICFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBSPECIFICFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBSPECIFICFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBSPECIFICFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBSPECIFICFIELD actions', async () => {
      const expectedActions = [
        {
