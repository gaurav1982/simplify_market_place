...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './location-prefrence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONPREFRENCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOCATIONPREFRENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOCATIONPREFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCATIONPREFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCATIONPREFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONPREFRENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCATIONPREFRENCE actions', async () => {
      const expectedActions = [
        {
