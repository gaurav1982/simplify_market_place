...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OTPATTEMPT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OTPATTEMPTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OTPATTEMPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OTPATTEMPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OTPATTEMPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OTPATTEMPT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OTPATTEMPT actions', async () => {
      const expectedActions = [
        {
