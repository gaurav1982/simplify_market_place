...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OTP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OTPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OTP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OTP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OTP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OTP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OTP actions', async () => {
      const expectedActions = [
        {
