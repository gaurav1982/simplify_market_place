...
export const OTPDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simplifyMarketplaceApp.oTP.delete.question">
        <Translate contentKey="simplifyMarketplaceApp.oTP.delete.question" interpolate={{ id: oTPEntity.id }}>
