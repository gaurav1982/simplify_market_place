...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBPREFERENCE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_JOBPREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_JOBPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBPREFERENCE actions', async () => {
      const expectedActions = [
        {
