...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EMPLOYMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EMPLOYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYMENT actions', async () => {
      const expectedActions = [
        {
