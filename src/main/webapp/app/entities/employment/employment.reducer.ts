...
const apiSearchUrl = 'api/_search/employments';

// Actions

export const searchEntities = createAsyncThunk('employment/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IEmployment, thunkAPI) => {
    const result = await axios.post<IEmployment>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IEmployment, thunkAPI) => {
    const result = await axios.put<IEmployment>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IEmployment, thunkAPI) => {
    const result = await axios.patch<IEmployment>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IEmployment>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
